...
PRIVATE_CONFIG=tm1.conf nohup geth --datadir qdata/issuer1 $GLOBAL_ARGS --rpcport 22000 --port 21000 --unlock 0 --voteaccount "0x8a19fcbf7150d5ede014fd706ff246176a2c85fa" --votepassword "" --password passwords.txt 2>>qdata/logs/1.log &
sleep 5
echo "[*] Starting node issuer2"
PRIVATE_CONFIG=tm2.conf nohup geth --datadir qdata/issuer2 $GLOBAL_ARGS --rpcport 22001 --port 21001 --voteaccount "0x4eccf8ee8dc91ad5b3562255791bf06ca12ae1f3" --votepassword "" --blockmakeraccount "0x2351c97c88f3d630d421c6c04d17686b12b24e71" --blockmakerpassword "" --singleblockmaker --minblocktime 1 --maxblocktime 10 --password passwords.txt 2>>qdata/logs/2.log &
sleep 5
echo "[*] Starting node investor1"
PRIVATE_CONFIG=tm3.conf nohup geth --datadir qdata/investor1 $GLOBAL_ARGS --rpcport 22002 --port 21002 --voteaccount "0x60422cbf0a1585ab2aa341e8d1f1f47361e5de7a" --votepassword ""  --password passwords.txt 2>>qdata/logs/3.log &
sleep 5
echo "[*] Starting node investor2"
PRIVATE_CONFIG=tm4.conf nohup geth --datadir qdata/investor2 $GLOBAL_ARGS --rpcport 22003 --port 21003 --voteaccount "0x1efa9fa1bb1430309dbfda51949e4d4f3c4135d3" --votepassword ""  --password passwords.txt 2>>qdata/logs/4.log &
sleep 5 
echo "[*] Starting node nsdl"
PRIVATE_CONFIG=tm5.conf nohup geth --datadir qdata/nsdl $GLOBAL_ARGS --rpcport 22004 --port 21004 --voteaccount "0x65b70b9055dcca77ffb730df2591b78c01bcbd9d" --votepassword "" --password passwords.txt 2>>qdata/logs/5.log &
