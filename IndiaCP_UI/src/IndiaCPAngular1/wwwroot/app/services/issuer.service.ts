...
module app.services {
    "use strict";
     ...
     export interface IIssuerService{
         addDoc (file: any, extraHttpRequestParams?: any ) : ng.IHttpPromise<IndiaCPProgram>;
         addISIN (cpProgramId: string, isin: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<IndiaCPProgram>;
         fetchAllCP (entity: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<IndiaCPIssue>>;
         fetchAllCPForCPProgram (issuer: string, cpProgramId: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<IndiaCPIssue>>;
         fetchAllCPProgram (extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<IndiaCPProgram>>;
         fetchCP (entity: string, cpIssueId: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<IndiaCPIssue>;
         fetchCPProgram (cpProgramId: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<IndiaCPProgram>;
         issueCPProgram (cpprogramDetails: IndiaCPProgram, extraHttpRequestParams?: any ) : ng.IHttpPromise<IndiaCPProgram>;
     }
     ...
     class IssuerService implements IIssuerService {
         ...
         */
        public addDoc (file: any, extraHttpRequestParams?: any ) : ng.IHttpPromise<IndiaCPProgram> {
         ...
         */
        public addISIN (cpProgramId: string, isin: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<IndiaCPProgram> {
         ...
         */
        public fetchAllCP (entity: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<IndiaCPIssue>> {
         ...
         * @param cpProgramId CP Program ID that uniquely identifies the CP Program issued by the Issuer
         */
        public fetchAllCPForCPProgram (issuer: string, cpProgramId: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<IndiaCPIssue>> {
         ...
         */
        public fetchAllCPProgram (extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<IndiaCPProgram>> {
         ...
         */
        public fetchCP (entity: string, cpIssueId: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<IndiaCPIssue> {
         ...
         * @param cpProgramId CP Program ID that uniquely identifies the CP Program issued by the Issuer
         */
        public fetchCPProgram (cpProgramId: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<IndiaCPProgram> {
         ...
         */
        public issueCPProgram (cpprogramDetails: IndiaCPProgram, extraHttpRequestParams?: any ) : ng.IHttpPromise<IndiaCPProgram> {
