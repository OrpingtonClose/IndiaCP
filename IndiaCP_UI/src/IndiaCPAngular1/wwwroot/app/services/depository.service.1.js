...
(function (app) {
    ...
    (function (services) {
        "use strict";
        var DepositoryService = (function () {
            function DepositoryService($http, localStorageService, Upload, $httpParamSerializer) {
                this.$http = $http;
            ...
            DepositoryService.prototype.extendObj = function (objA, objB) {
                for (var key in objB) {
             ...
             */
            DepositoryService.prototype.addISIN = function (cpProgramId, isin, extraHttpRequestParams) {
        ...
        DepositoryService.$inject = ["$http", "localStorageService", "Upload", "$httpParamSerializer"];
        angular
            .module("app.services")
            .service("app.services.DepositoryService", DepositoryService);
    })(services = app.services || (app.services = {}));
})(app || (app = {}));
//# sourceMappingURL=depository.service.1.js.map