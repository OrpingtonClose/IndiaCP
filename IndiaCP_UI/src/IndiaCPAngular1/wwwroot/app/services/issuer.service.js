...
(function (app) {
    ...
    (function (services) {
        ...
        var IssuerService = (function () {
            function IssuerService($http, localStorageService, Upload, $httpParamSerializer) {
                this.$http = $http;
            ...
            **/
             ...
             */
            IssuerService.prototype.CPissueGetTransactionHistory = function (cpIssueId, extraHttpRequestParams) {
                var localVarPath = this.basePath + "/indiacpissue/getTransactionHistory/{cpIssueId}"
             ...
             */
            IssuerService.prototype.CPProgramGetTransactionHistory = function (cpProgramId, extraHttpRequestParams) {
                var localVarPath = this.basePath + "/indiacpprogram/getTransactionHistory/{cpProgramId}"
             ...
             */
            IssuerService.prototype.fetchCreditRating = function (extraHttpRequestParams) {
                var localVarPath = this.basePath + "/creditrating/fetchCreditRating";
                var queryParameters = {};
                var headerParams = this.extendObj({}, this.defaultHeaders);
                var httpRequestParams = {
                    method: "GET",
             ...
             * @param file Document Attachment
             */
            IssuerService.prototype.issueCreditRating = function (creditRatingDetails, file, extraHttpRequestParams) {
                var localVarPath = this.basePath + "/creditrating/issueCreditRating";
                var queryParameters = {};
                var headerParams = this.extendObj({}, this.defaultHeaders);
                var formParams = {};
        ...
        IssuerService.$inject = ["$http", "localStorageService", "Upload", "$httpParamSerializer"];
        angular
            .module("app.services")
