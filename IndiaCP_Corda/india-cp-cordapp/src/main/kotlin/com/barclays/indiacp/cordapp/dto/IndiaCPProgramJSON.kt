...
(
    ...
    val issue_commencement_date: Date = Date(),

    val program_size: Double = 0.0,

    val program_allocated_value: Double = 0.0,

    val program_currency: String = "",

    val maturity_days: Date = Date(),
    ...
    val isin_generation_request_doc_status: String = "",
