package com.barclays.indiacp.bean;

import static org.apache.commons.io.FileUtils.*;

import com.barclays.indiacp.util.ProcessUtils;
import com.barclays.indiacp.util.SortedProperties;
...
//        AppConfig.initVendorConfig(new File(configFile));
    ...
    private void initGethBean() throws IOException {
        ...
        if (!ProcessUtils.ensureFileIsExecutable(gethPath)) {
    ...
    private void ensureNodeBins(String nodePath) {
        ProcessUtils.ensureFileIsExecutable(nodePath + File.separator + "node");
        ProcessUtils.ensureFileIsExecutable(nodePath + File.separator + "node.exe");
    }
