...
import com.barclays.indiacp.service.EventService;
...
public class TransactionServiceImpl implements TransactionService {
    ...
    private Transaction processTx(Map<String, Object> txData) throws APIException {
        ...
        if (tx.getContractAddress() == null && tx.getStatus() == Transaction.Status.committed) {
    ...
    public Transaction waitForTx(TransactionResult result, long pollDelay, TimeUnit pollDelayUnit)
        ...
        while (true) {
            ...
            if (tx.getStatus() == null ? Transaction.Status.committed.toString() == null : tx.getStatus().equals(Transaction.Status.committed)) {
                break;
            }
