...
public class IndiaCPRefDataAppMain
{
   ...
   UserDetailsService userDetailsService;
    ...
    private void testRun()
    {
        ...
        LegalEntity le = new LegalEntity("Mo Bank","12312312312312","Kuala Lumpur","0612-232223232","","Kuala,Lumpur@kl.com","kualalumpur.com","","Mr. KL");
        LegalEntity le1 = new LegalEntity("Bank of America","567567567","America","+1 99999999","","United States of America","unitedstates.com","","Mr. US");


        ArrayList<UserDetails> arrUser = new ArrayList<UserDetails>();

        arrUser.add(new UserDetails("person DE", "Finance", "Langkawi","+613 232323232","langkawi@kl.com"));
        arrUser.add(new UserDetails("person FG","Operations","Malacca", "+613 1000 000 00", "malacca@kl.com"));
        le.setUserDetails(arrUser);

        ArrayList<SettlementDetails> arrSettlement = new ArrayList<SettlementDetails>();

        arrSettlement.add(new SettlementDetails("HDFC Bank", "121211212", "Barclays","50000","123123123","1231231231","45645645", "675675", "34232"));
        arrSettlement.add(new SettlementDetails("BILIL","6445645","Yes Bank", "HDFC0000", "56456464", "35346346","78678687", "786856856", "79878978"));
       ...
       System.out.println(settlementDetailsService.listAll());
       System.out.println(legalEntityService.getLegalEntityByID("2"));
