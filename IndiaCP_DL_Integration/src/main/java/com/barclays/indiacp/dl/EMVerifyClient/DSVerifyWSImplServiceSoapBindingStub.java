/**
 * DSVerifyWSImplServiceSoapBindingStub.java
 *
...
public class DSVerifyWSImplServiceSoapBindingStub extends org.apache.axis.client.Stub implements DSVerifyWS {
    ...
    public DSVerifyWSImplServiceSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public DSVerifyWSImplServiceSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public DSVerifyWSImplServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public String verify(String arg0, String arg1, String arg2) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://ds.ws.emas/", "verify"));
